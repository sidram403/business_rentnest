...
function ProductCard({ imgUrl, title, desc }) {
  return (
    <>
      <div className="flex justify-between flex-col px-5 py-5 w-full rounded-[20px] max-w-[322px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
        <img
          src={imgUrl}
          alt="imgurl"
          className="w-[400px] h-[250px] rounded-[16px]"
        />
        <h2 className="font-poppins font-bold text-[22px] leading-[32px] text-gradient text-center my-4 ">
          {title}
        </h2>
